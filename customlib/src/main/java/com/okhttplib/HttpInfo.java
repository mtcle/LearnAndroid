...
public class HttpInfo {
    ...
    public final static int RequestForbiddened = 16;
    public final static int RequestMethodError = 17;
    ...
    public HttpInfo packInfo(int netCode, int retCode, String retDetail) {
        ...
        switch (retCode) {
            case NonNetwork:
                ...
                break;
            case SUCCESS:
                if(StringUtils.isBlank(retDetail)){
            ...
            case NoResult:
                ...
                break;
            case RequestForbiddened:
                this.retDetail = "无法获取返回信息(连接拒绝)";
                break;
            case CheckURL:
            ...
            case Message:
                ...
                break;
            case GatewayTimeOut:
                this.retDetail = "请求超时，请检查网络连接是否正常";
                break;
            case GatewayBad:
            ...
            case RequestMethodError:
                this.retDetail="请求方法错误";
                break;
            default:
                if (!TextUtils.isEmpty(retDetail)) {
                    this.retDetail = retDetail;
                } else {
                    this.retDetail = "未知错误[" + retCode + "]";
                }
                break;
        }
        return this;
